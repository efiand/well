...
Сборка — [gulp cooker](https://github.com/efiand/gulp-cooker) с модифицированным nunjucks-шаблоном для встраивания стилей, скриптов и символьного спрайта в HTML-код.
